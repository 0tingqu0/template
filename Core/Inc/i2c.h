...
void HAL_I2C_WriteCommand_DMA(I2C_HandleTypeDef *hi2c, uint16_t DevAddress, uint8_t Control_bytes, uint8_t Command);
void HAL_I2C_WriteData_DMA(I2C_HandleTypeDef *hi2c, uint16_t DevAddress, uint8_t Control_bytes, uint8_t Command);
